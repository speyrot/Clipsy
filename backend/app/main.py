...
from app.routes import upload_routes, detect_routes, process_routes, status_routes, layout_routes, processed_video_routes, auth_routes, user_routes, task_routes, tag_routes
import os
